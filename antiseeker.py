...
-p    Разобрать искателья -p [ссылка]
     \033[33m -p https://*****.ngrok.io \033[0m

-c    Уничтожить искателья -c [ссылка]
     \033[33m -c https://*****.ngrok.io \033[0m

-l    Отследить гео данные -l [время] [ссылка]
...
if sys.argv[1] == "-p":
    ...
    if jres == "":
        ...
        print("Доставшик   : "+jres['dev'][0]['render'])
elif sys.argv[1] == "-c":
    url = sys.argv[2]
    Lat = 'qw%27erty000"'
    Lon = "qwert'y000 %22"
